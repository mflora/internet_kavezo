...
public class ModifyView extends JFrame{
    ...
    public ModifyView(Controller controller){
        ...
        inName.setMinimumSize(new Dimension(200, 40));
        inName.setMaximumSize(new Dimension(200, 40));
        
        inAddress = new JTextField();
        inAddress.setMinimumSize(new Dimension(200, 40));
        inAddress.setMaximumSize(new Dimension(200, 40));
        
        inID = new JTextField();
        inID.setMinimumSize(new Dimension(200, 40));
        inID.setMaximumSize(new Dimension(200, 40));
        
        inUsername = new JTextField();
        inUsername.setMinimumSize(new Dimension(200, 40));
        inUsername.setMaximumSize(new Dimension(200, 40));
        
        inPw = new JPasswordField();
        inPw.setMinimumSize(new Dimension(200, 40));
        inPw.setMaximumSize(new Dimension(200, 40));
        ...
        buttonPressed = new AbstractAction(){
            ...
            public void actionPerformed(ActionEvent event){
                ...
                if (event.getSource() == saveButton){
                    ...
                    if(controller.modifyCustomer(customerInfo)){
